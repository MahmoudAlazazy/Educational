import 'package:edux/data/courses_data.dart';
import 'package:edux/pages/course_deatail_page.dart';
import 'package:edux/widget/tag.dart';
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      child: ListView.builder(
        shrinkWrap: true,
        scrollDirection: Axis.vertical, // تغيير الاتجاه إلى عمودي
...
class CourseTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 10), // تعديل الهوامش ليكون العرض عموديًا
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
              margin: const EdgeInsets.only(bottom: 8),
              constraints: const BoxConstraints.expand(height: 200, width: double.infinity), // تعديل العرض
            ...
            Row(
              children: [
                Text(
                  price,
                  style: TextStyle(fontSize: 14, color: Colors.yellow[900], fontWeight: FontWeight.bold),
                ),
